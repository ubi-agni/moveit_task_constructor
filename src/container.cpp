...
inline const SubTaskPrivate *SerialContainerPrivate::prev(const SubTaskPrivate *child) const
{
	return prev(it(child));
}

inline const SubTaskPrivate *SerialContainerPrivate::next(const SubTaskPrivate *child) const
{
